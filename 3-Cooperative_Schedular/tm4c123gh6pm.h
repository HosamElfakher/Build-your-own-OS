...
struct INT_CTRL_REG_Bits
{
	...
	uint32_t ISRPRE : 1 ;
	uint32_t Reserved2 : 1;
	uint32_t PENDCTCLR : 1;
	uint32_t PENDCTSET : 1;
	uint32_t UNPENDSV : 1;
	uint32_t PENDSV : 1;
...
union INT_CTRL_REG
{
	struct INT_CTRL_REG_Bits bit;
	uint32_t all;
};
typedef struct SYS_CTRL_REGs
{
	union INT_CTRL_REG				INTCTRL;
}SYS_CTRL_REGs;
	
#define System_Base										0x400FE000
#define System_Control_Base						0xE000E000
	
#define Control_REGs_Offset					  0xD04
#define Systick_Offset							  0x0010
#define RCC_Offset									  0x050
#define Sys_INT_Priority_Offset				0x0D18

#define SYS_CTRL							((volatile SYS_CTRL_REGs		    *)(System_Control_Base+Control_REGs_Offset))	
#define SYSTICK								((volatile SysTick_REGs				   *)(System_Control_Base+Systick_Offset))
#define SYS_INT_Priority			((volatile SYS_INT_Priority_REGs *)(System_Control_Base+Sys_INT_Priority_Offset))
	
#define Run_Clock_CONF				((volatile System_CTRL_REGS		   *)(System_Base+RCC_Offset))
