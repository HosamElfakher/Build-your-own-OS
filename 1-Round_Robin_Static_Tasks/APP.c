...
// APP.c
// Runs on TM4C123
// A software application to prove the use of Static Round Rubin Schedular. Static means 
// the number of threads is predefined at design time, No remove for threads just adding the 
// predefined ones.
 ...
 **********************************************************************************/
 /*******************************Note**********************************************
 *This version is tested on simulator wheres the logic analyzer is working well.
